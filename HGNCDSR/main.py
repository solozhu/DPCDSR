...
if __name__ == '__main__':
    ...
    path1 = "./dataset/Entertainment-Education/traindata_new.txt"
    path2 = "./dataset/Entertainment-Education/validdata_new.txt"
    path3 = "./dataset/Entertainment-Education/validdata_new2.txt"
